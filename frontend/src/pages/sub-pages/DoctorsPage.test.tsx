...
import DoctorsPage from './DoctorsPage.tsx';
//import Loader from '../../components/UI/Loader.tsx';
//import TopSearchBar from '../../components/UI/TopSearchBar.tsx';
//import TopSearchBar from '../../components/UI/TopSearchBar.tsx';

//import { getDoctorWithAvailabilitiesMock } from './../../_testUtils/mocks/mockHttp';
...
describe('Doctors Page', () => {
  beforeEach(() => {
    //jest.clearAllMocks();
    // jest.spyOn(store, 'dispatch').mockImplementation((state,action)=>{
    //   if(type === 'doctors/fetch/fulfilled') {
  ...
  it('2--After rendering useEffect fetch doctors', async () => {
    ...
    console.log(store.getState().doctors);
